...
def load_cloud_worker_health() -> dict:
    ...
    return {
        ...
        "last_inflight_count": int(worker_state.get("last_inflight_count") or 0),
        ...
        "last_inflight_sample": worker_state.get("last_inflight_sample") or [],
        "last_candidate_campaign_ids": worker_state.get("last_candidate_campaign_ids") or [],
        ...
        "last_selected_campaign_id": str(worker_state.get("last_selected_campaign_id") or "").strip(),
        "last_selected_due_at": str(worker_state.get("last_selected_due_at") or "").strip(),
        "claimed_campaign_id": str(worker_state.get("claimed_campaign_id") or "").strip(),
        "claimed_manifest_uri": str(worker_state.get("claimed_manifest_uri") or "").strip(),
        ...
        "inbox_cap_timezone": str(worker_state.get("inbox_cap_timezone") or "UTC").strip() or "UTC",
        "inbox_daily_cap": int(worker_state.get("inbox_daily_cap") or 0),
        "inbox_hourly_cap": int(worker_state.get("inbox_hourly_cap") or 0),
        "inbox_sent_today": int(worker_state.get("inbox_sent_today") or 0),
        "inbox_remaining_today": int(worker_state.get("inbox_remaining_today") or 0),
        "inbox_sent_last_hour": int(worker_state.get("inbox_sent_last_hour") or 0),
        "inbox_remaining_this_hour": int(worker_state.get("inbox_remaining_this_hour") or 0),
        "weekend_sending_enabled": bool(worker_state.get("weekend_sending_enabled", True)),
        "next_capacity_due_at": str(worker_state.get("next_capacity_due_at") or "").strip(),
        "next_capacity_reason": str(worker_state.get("next_capacity_reason") or "").strip(),
        "last_live_email_count": int(worker_state.get("last_live_email_count") or 0),
        "last_manifest_email_count": int(worker_state.get("last_manifest_email_count") or 0),
        "last_inflight_email_count": int(worker_state.get("last_inflight_email_count") or 0),
        "last_carryover_email_count": int(worker_state.get("last_carryover_email_count") or 0),
